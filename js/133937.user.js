// ==UserScript==
// @name 		LoUAlsius tools
// @description 	Adds extra functionality to Lord of Ultima
// @namespace 		Alsius
// @include 		http://prodgame23.lordofultima.com/120/index.aspx*
// @version 		0.8.8
// @require 		http://sizzlemctwizzle.com/updater.php?id=133937&days=1
// ==/UserScript==
(function () {
  /*
   * Changelog
  ...
  var main = function () {
      ...
      const AlsiusTweakVersion = '0.8.8';
      ...
      var createTweak = function () {
          ...
          const EXTversion     = AlsiusTweakVersion;

          const EXTbotname     = "Alse";
          const EXTgreeting    = "Strength in Unity";

          const EXTauthors     = "BloodHeart";
          const EXTpolltrip    = 1000 * 60 * 5;
          const EXTdataversion = '1.3';
          const EXTendpoint    = 'data_1_3.php';
          const EXTprovider    = 'http://gf56ts4.deliberate.de/service/ajaxEndpoint/';
          ...
          qx.Class.define("AlsiusTweak.Main", {
            ...
            members: {
              ...
              tweakEXT: function () {
                ...
                this.panel = new AlsiusTweak.ui.ExtraTools("Alsius Tools v" + EXTversion + ' ~ ' + EXTgreeting + ' ~ ');
              ...
              inception: function () {
                AlsiusTweak.Inception.getInstance().init();
              },
              toolTip: function () {
                AlsiusTweak.Tooltip.getInstance().init();
              },
              addPanel: function (panel) {
                this.bQc.getLayoutParent().addBefore(panel, this.bQc);
              },
              logOn: function () {
                this.chat.addMsg('/whisper ' + EXTbotname + ' !alsius.lou.Login ' + EXTversion + ' ' + webfrontend.net.CommandManager.getInstance().getInstanceGuid());
              },
              hijackMessage: function () {
                AlsiusTweak.Chat.getInstance().init();
              },
          ...
          qx.Class.define("AlsiusTweak.Provider", {
            ...
            members: {
              ...
              Key: null,
              pollData: function (o) {
                this.Key = AlsiusTweak.Command.getInstance().getKey();
          ...
          qx.Class.define("AlsiusTweak.Tooltip", {
            ...
            members: {
              ...
              getLawlessCityTooltip: function (ca, cb, cs, ct, cu, cv, cw) {
                ...
                var cd = AlsiusTweak.Provider.getInstance().getContiData(cc);
              ...
              getCityTooltip: function (bu, bv, bw, name, bx, by, bz, bA, bB, bC, bD, bE, bF, bG, bH, bI, bJ) {
                ...
                var bD2 = AlsiusTweak.Provider.getInstance().getContiData(bc);
            ...
            statics: {
              ...
              _getCityTooltip: function (bu, bv, bw, name, bx, by, bz, bA, bB, bC, bD, bE, bF, bG, bH, bI, bJ, bD2) {
                ...
                if (bD2 != null) {
                  ...
                  var pre = bS.get();
                  AlsiusTweak.Tooltip._buildSettlerTip(bS, bD2, pos);
                  ...
                  if (pre == bS.get()) AlsiusTweak.Tooltip._buildEmptyDataTip(bS);
                } else {
              ...
              _getLawlessCityTooltip: function (ca, cb, cs, ct, cu, cv, cw, cd) {
                ...
                if (cd != null) {
                  ...
                  if (!ca) AlsiusTweak.Tooltip._buildSettlerTip(cy, cd, pos, true);
              ...
              _buildNoDataOrAccess: function(br) {
                 br.add(bl3 + 'Alsius Tools:' + m + nb + nb + nb + nb + nb + nb + nb + nb + nb + nb + webfrontend.gui.Util.convertBBCode(i18n('ext:no_data_or_credentials')) + l);
              },
              _buildProcessHeadline: function(br) {
                 br.add(bl2 + 'Alsius Tools: v' + EXTversion + l2 + kl + hl + l);
              },
            ...
            members: {
              ...
              onNewMessage: function (e) {
                ...
                if (eu.c == 'privatein' && eu.s == EXTbotname) {
                  var commands = AlsiusTweak.Command.getInstance();
                  var t = /^!alsius\.lou\.[a-zA-Z]*[\.]?.*/;
                  var p = /^!alsius\.lou\.Command\.([a-zA-Z]*) (.*)$/;
                  var d = /^!alsius\.lou\.Data\.([a-zA-Z]*) (.*)$/;
                  var r = /^!alsius\.lou\.Error\.([a-zA-Z]*) (.*)$/;
                  var pq = eu.m;
                  if (t.test(pq)) {
              ...
              addChatMessage: function (message, prefix) {
                var prefix = (prefix) ? 'Alsius Tools: (' + AlsiusTweakVersion + ') ' : '';
          ...
          qx.Class.define("AlsiusTweak.Command", {
            ...
            members: {
              ...
              setKey: function (key) {
                ...
                if (key != '') {
                  this.commandKey = key;
                  AlsiusTweak.Main.getInstance().registerTick();
                  AlsiusTweak.Main.getInstance().setPanelState(true);
                  AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:you_are_logged_in') + '!', true);
                  return true;
                } else {
                  this.commandKey = null;
                  AlsiusTweak.Main.getInstance().unRegisterTick();
                  AlsiusTweak.Main.getInstance().setPanelState(false);
                  AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:login_failed') + '!', true);
                  return false;
                }
              },
              getKey: function () {
              ...
              error: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:error_on_command') + ': ' + data.charAt(0).toUpperCase() + data.slice(1) + '@' + sender, true);
                return false;
              },
              ok: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:ok_message') + ': ' + data.charAt(0).toUpperCase() + data.slice(1) + '@' + sender, true);
                return false;
              },
              like: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage('[<span id="CHAT_SENDER_' + sender + '" style="cursor:pointer;">' + sender + '</span>]' + i18n('ext:like_message'));
                return true;
              },
              poke: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage('[<span id="CHAT_SENDER_' + sender + '" style="cursor:pointer;">' + sender + '</span>]' + i18n('ext:poke_message'));
                return true;
              },
              vote: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage('[<span id="CHAT_SENDER_' + sender + '" style="cursor:pointer;">' + sender + '</span>]' + i18n('ext:vote_message'));
                return true;
              },
              love: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:love_message'));
                return true;
              },
              slap: function (data, sender) {
                AlsiusTweak.Chat.getInstance().addChatMessage(i18n('ext:slap_message'));
                return true;
              },
            }
          });
          ...
          qx.Class.define("AlsiusTweak.ui.ExtraTools", {
            ...
            members: {
              ...
              checkButtons: function () {
                this.fillQueueButton.setEnabled(AlsiusTweak.Main.getInstance().ministerPresent.BuildMinister);
                this.payQueueButton.setEnabled(AlsiusTweak.Main.getInstance().ministerPresent.BuildMinister);
                this.cancelAllButton.setEnabled(AlsiusTweak.Main.getInstance().ministerPresent.MilitaryMinister);
                this.cancelRaidsButton.setEnabled(AlsiusTweak.Main.getInstance().ministerPresent.MilitaryMinister);
                this.scheduleButton.setEnabled(AlsiusTweak.Main.getInstance().ministerPresent.MilitaryMinister);
                qx.util.TimerManager.getInstance().start(function () {
                  this.checkButtons();
                }, null, this, null, 1000 * 60);
              }
          ...
          qx.Class.define("AlsiusTweak.ui.AboutWindow", {
            ...
            extend: qx.ui.window.Window,
            construct: function () {
              this.base(arguments, 'Alsius Tools v' + EXTversion);
              this.buildUI();
            ...
            members: {
              ...
              buildUI: function () {
                ...
                var license = "Alsius Tools - GreaseMonkey script for Lord of Ultima™";
          ...
          if (typeof qx == 'undefined') {
            ...
            if (checkDependencies()) {
              if (!startup.initialized) {
                ...
                createTweak();
                AlsiusTweak.Main.getInstance().initialize();
              }
            } else {
